...
/* Surface vertex generated by a light subpath for Metal bidirectional path tracing. The incoming
...
enum PixelDisplacementEvaluatorFlags {
  ...
  PIXEL_DISPLACEMENT_RIGID_TRANSFORMS = 512,
  PIXEL_DISPLACEMENT_NORMAL_IMAGE_INPUTS = 1024,
  PIXEL_DISPLACEMENT_SCALAR_IMAGE = 2048,
  PIXEL_DISPLACEMENT_IDENTITY_MAPPING = 4096,
};
...
#undef DECLARE_FILM_CONVERT_KERNEL
  ...
  DEVICE_KERNEL_GUIDING_FIT_REDUCE,
